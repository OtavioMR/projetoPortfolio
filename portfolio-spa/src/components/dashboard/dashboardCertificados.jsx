...
export default function DashboardCertificado() {
        ...
        <div className="row">
            <div className="col-12 d-flex justify-content-center align-items-center mb-0">
                <div className="cardLogin my-3 p-5">
                    <h2 className=" py-3 ">Certificados</h2>

                    <div className="cargo mb-3">
                        <p className="mb-0">Nome certificado:</p>
                        <input type="text" />
                    </div>
                    ...
                    <div className="sobreCargo my-3">
                        <label htmlFor="mensagem" className="mb-1">Sobre o certificado:</label>
                        <textarea
                            name="mensagem"
                            id="sobreCargo"
                            rows={4}
